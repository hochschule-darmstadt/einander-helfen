  ...
  <div class="privacy">
    ...
    <section class="container pt-6">
      ...
      <p>
        ...
        Betreiber der Seitenbehaltensich ausdrücklich rechtliche Schritte im
      ...
      <p>
        ...
        Daten zum Verhalten der Besucher werden gesammelt um eventuelle Probleme
        wie nicht gefundene Seiten, Suchmaschinenprobleme oder unbeliebte Seiten
        herauszufinden. Sobald die Daten (Anzahl der Besucher die Fehlerseiten
        oder nur eine Seite sehen, usw.) verarbeitet werden, erzeugt Matomo
        Berichte für die Webseitenbetreiber, damit diese darauf reagieren
        können. (Layoutveränderungen, neue Inhalte, usw.). Die Daten werden
        lediglich auf den Servern von einander-helfen.org gespeichert und nicht
      ...
      <strong>
        ...
        Aktionen (Tracking) nicht angezeigt werden kann, da es von Ihrem Browser
        blockiert wird. Möglicherweise blockiert dieser dann ohnehin das
        Tracking, sodass Sie Ihr Einverständnis dafür hier nicht mehr entziehen
        müssen. Wenn Sie auf Nummer sicher gehen wollen, sollten Sie Ihren
        AdBlocker deaktivieren und die Seite neu laden, um manuell die Erlaubnis
        zum Tracken zu entziehen.
      </strong>
